...
const rows: [
  ...
  [
    ...
    "#795ca9",
    "EXECUTION",
    "A colossal scythe executes the ordinary enemies ahead after a 0.6s windup and erases their hazards.",
  ...
  [
    ...
    "#fff0bd",
    "EXPOSE",
    "For 8s, strip ordinary enemy armor and let the next arsenal hit execute them.",
  ...
  [
    ...
    "#dfedff",
    "STASIS",
    "Suspend ordinary enemies and their attack clocks for 6s, preserving warning time.",
  ...
  [
    ...
    "#e0fbff",
    "DISPLACEMENT",
    "A giant tidal fish deals 60% maximum durability, clears hazards and pushes enemies back 12m. Survivors slow for 4s.",
  ...
  [
    ...
    "#fff3b7",
    "OVERDRIVE",
    "All ordinary guns fire at triple cadence and deal 1.5× damage for 8s.",
  ...
  [
    ...
    "#ffb55c",
    "BURN FIELD",
    "Three thorn sigils burn enemies for 25% maximum durability per second for 8s.",
  ...
  [
    ...
    "#fff6cf",
    "RETALIATION",
    "Prevent 75% of combat damage for 10s. Blocking an attack fires a retaliatory coin at its source.",
  ...
  [
    ...
    "#f5d778",
    "TURRET",
    "A crown turret fires 12 rounds a second for 8s, each dealing 20% maximum durability.",
  ...
  [
    ...
    "#f8eaff",
    "PHASE",
    "Phase through contact, hazards and curbs for 6s. Gates still apply; enemies passing through give no rewards.",
  ...
  [
    ...
    "#d9f5ff",
    "CHAIN STORM",
    "Three birds arc lightning through up to five enemies every 0.75s for 6s, dealing 45% durability per strike.",
  ...
  [
    ...
    "#ffffe5",
    "AIMED BEAM",
    "Aim a 2m-wide solar beam with the mouse for 6s. Deals 100% maximum durability per second.",
    "Combined boss damage capped at 35% maximum health.",
  ...
  [
    ...
    "#eafff5",
    "RECOVERY",
    "Restore 60% of unrecovered combat casualties from the last 15s. Gain temporary shield equal to half your army, minimum 30.",
    "Temporary shield absorbs boss attacks for 8s.",
  ...
  [
    ...
    "#ccabff",
    "FORTUNE",
    "For 15s or three gates, use the better side, double recruitment gains and neutralize losses.",
  ...
  [
    ...
    "#ff947c",
    "COMPANIONS",
    "Two spectral companions duplicate your ordinary arsenal for 10s, each at 50% damage.",
  ...
  [
    ...
    "#ffd5da",
    "DUEL",
    "Mark the toughest threat: ordinary arsenal hits gain 200% bonus damage for 10s. Transfers on death, up to three targets.",
  ...
  [
    ...
    "#fff1bc",
    "HUNTER",
    "A bronze leopard executes six nearby ordinary threats in rapid succession.",
  ...
  [
    ...
    "#edf5ff",
    "BOMBARDMENT",
    "Five paired bombardments hit ten columns across the road, each for 100% maximum durability.",
    "All ten columns share a 35% boss-health damage budget.",
  ...
  [
    ...
    "#d9f2ee",
    "SAFE CORRIDOR",
    "Push enemies out of the center lane, slow their advance by 60% and extinguish center-lane hazards for 10s.",
  ...
  [
    ...
    "#f5bfed",
    "GRAPPLE",
    "Six tentacles hold and crush enemies for 35% maximum durability per second for 6s.",
  ...
  [
    ...
    "#f1ffce",
    "SALVAGE",
    "Magnetize all existing pickups and apply each twice. For 8s, every third eligible kill recruits five soldiers, up to five times.",
  ...
  [
    ...
    "#ffcdc0",
    "BARRICADE",
    "Three walls hold ordinary enemies for 8s. Each has durability equal to your army; friendly shots pass through.",
  ...
  [
    ...
    "#9ab9b4",
    "ABSORB / RELEASE",
    "Absorb combat damage up to twice your army for 8s, then clap: each point absorbed adds 1% durability damage, up to 100%.",
  ...
  [
    ...
    "#fff2d3",
    "PROXIMITY GUARD",
    "Orbit 24 quills for up to 8s. Fire one every 0.15s at threats within 12m, dealing 60% durability.",
  ...
  [
    ...
    "#c08bff",
    "HAZARD REVERSAL",
    "For 8s, hazards spare your squad and hit enemies in their lanes for 35% durability. Pools tick each second.",
  ...
  [
    ...
    "#ffffff",
    "SILENCE",
    "For 10s, cancel pending and new attacks or summons and punish each canceled action for 40% durability. Active hazards continue.",
